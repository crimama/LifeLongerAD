...
class IUF(nn.Module):
    ...
    def cuda(self):
        ...
        return super(IUF, self).cuda()

    def cpu(self):
        self.device = torch.device("cpu")
        return super(IUF, self).cpu()

    def forward(self, input) -> dict:
        '''
        Final Outputs:
            dict: A dictionary containing:
                - "feature_rec": Reconstructed feature map.
                - "feature_align": Original aligned feature map.
                - "pred": Upsampled prediction error between the reconstructed and original feature maps.
                - "class_out": Classification output from the input dictionary.
                - "middle_decoder_feature_0": Rearranged first middle decoder feature.
                - "middle_decoder_feature_1": Rearranged second middle decoder feature.
                - "middle_decoder_feature_2": Rearranged third middle decoder feature.
        '''
